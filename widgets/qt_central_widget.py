...
def configure(qt_main_window):
    ...
    # map menu
    qt_main_window.stacked_frame_dict["map"] = []
    qt_main_window.stacked_frame_dict["map"].append("view")
    qt_main_window.stacked_frame_dict["map"].append("layers")
    qt_main_window.stacked_frame_dict["map"].append("config")
    # devices
